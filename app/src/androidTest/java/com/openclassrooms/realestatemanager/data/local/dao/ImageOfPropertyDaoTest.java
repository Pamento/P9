...
public class ImageOfPropertyDaoTest {
    ...
    private static final SingleProperty SINGLE_PROPERTY_ONE = new SingleProperty("property_id_1","","",0,0,0,0,0,"","","","","","",0,"","","");
    private static final SingleProperty SINGLE_PROPERTY_TWO = new SingleProperty("property_id_2","","",0,0,0,0,0,"","","","","","",0,"","", "");
